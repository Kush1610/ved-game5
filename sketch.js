...
function setup() {
  ...
  bkground1=createSprite(width/2+450,height/2-60,20,20);
  bkground1.addImage(bg3Img);
  bkground1.scale=1.62;
  bkground1.visible=false

  bkground2=createSprite(width/2+3000,height/2-56,20,20);
  ...
  pl=createSprite(displayWidth/2+500,displayHeight/2-250,20,20);
  pl.addImage(playImg);
  pl.scale=0.3;
  pl.setCollider("rectangle",0,0,330,130);
  pl.visible=false

  ins=createSprite(displayWidth/2+500,displayHeight/2-150,20,20);
  ins.addImage(insImg);
  ins.scale=0.5;
  ins.visible=false

  about=createSprite(displayWidth/2+500,displayHeight/2-50,20,20);
  about.addImage(aboutImg);
  about.scale=1.2;
  //about.visible=false

  ins2=createSprite(displayWidth/2,displayHeight/2-70,20,20);
  ins2.addImage(ins2Img);
  ins2.scale=1.5;
  ins2.visible=false

  about2=createSprite(displayWidth/2,displayHeight/2-70,20,20);
  about2.addImage(about2Img);
  about2.scale=1.5;
  about2.visible=false

  cross=createSprite(displayWidth/2-450,displayHeight/2-400,20,20);
